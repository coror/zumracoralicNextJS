  ...
  return (
    <div className='bg-white pb-16 md:pb-40 pt-20 lg:pt-[8rem] overflow-hidden '>
      <div className='relative w-full md:h-96 overflow-hidden '>
        <Image
          src='https://res.cloudinary.com/dbssbnuph/image/upload/v1724664947/zumracoralic/putting-last-pebble-pile-stones_mr6ytd.jpg'
          alt='naslovna'
          sizes='100vw'
          width={0}
          height={0}
        ...
        <div className='absolute inset-0 flex flex-col justify-center items-center text-white m-8 pb-10 text-5xl md:text-[56px] mb-6 md:mb-16 tracking-wide leading-[1] text-center animate-fade-right animate-duration-[2000ms] animate-delay-[500ms]'>
          {n('services')}
        </div>
      </div>
