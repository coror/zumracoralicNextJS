  ...
  return (
    <div className='flex flex-col md:flex-row w-full overflow-hidden shadow-lg group border-[1px] bg-white'>
      ...
      <div className='p-4 relative flex flex-col space-y-10'>
        ...
        <Link href={eventsLink}>
          <p className=' text-black  bg-[#ffe6bc] py-2 px-4 inline-block mt-2 transition-all duration-300 md:hover:text-[#d2ab74] md:hover:bg-transparent border-2 border-[#ffe6bc] lg:absolute lg:right-10'>
            {readMore}...
          </p>
        </Link>
      </div>
