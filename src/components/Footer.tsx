...
export default function Footer({ connect }: { connect: string }) {
  return (
    <div className='relative w-full h-96 md:min-h-72 md:py-64 text-white'>
      <div
        className="w-full h-full absolute bg-no-repeat inset-0 bg-[url('https://res.cloudinary.com/dbssbnuph/image/upload/v1721487542/zumracoralic/footerimg_ecwkif')]"
        style={{
      ...
      >
        <div className='absolute inset-0 bg-[#222428] opacity-85'></div>
